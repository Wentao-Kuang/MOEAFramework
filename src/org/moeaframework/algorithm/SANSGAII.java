 ...
 * </ol>
 */
public class SANSGAII extends AbstractEvolutionaryAlgorithm implements
	 ...
	 */
	public SANSGAII(Problem problem, NondominatedSortingPopulation population,
			EpsilonBoxDominanceArchive archive, Selection selection,
			Variation variation, Initialization initialization, Initialization generator) {
			...
			while (offspring.size() < populationSize) {
				...
				for (int i = 0; i < parents.length; i++) {
					parents[i] = TournamentSelection.binaryTournament(
							pool.removeFirst(), pool.removeFirst(), comparator);
				}
